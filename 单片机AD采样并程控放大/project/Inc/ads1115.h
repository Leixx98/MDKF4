...
/****************************************************************8******/
#define ADS1115_SCL_SET        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_SET)
#define ADS1115_SCL_CLR        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET)                 
#define ADS1115_SDA_SET        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_SET)
#define ADS1115_SDA_CLR        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_RESET)
#define ADS1115_SDA_IN            GPIOC->MODER &=~(3<<(1*2))
#define ADS1115_SDA_OUT        GPIOC->MODER  |=    1<<(1*2)  
#define SDA_IN                                HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_1)

//ADS1115_SDAPort_IN()和ADS1115_SDAPort_OUT()函数定义在.c中，适应不同的单片机，更改IO口方向

//实际是没有用
#define AD_START   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_SET);
#define AD_END       HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_SET);
